...
@testset "MoAHMM-agents" begin
    ...
    @testset "miller-agents" begin
        ...
        α = 0.71
        @test isapprox(round.(model.β,digits=2),β,atol=0.01)
        @test isapprox(round.(get_params(agents,agent_options),digits=2)[1],α,atol=0.01)
        @test isapprox(ll,-15095.7,atol=0.1)
    end
    ...
    @testset "venditto-agents" begin
        ...
        @test isapprox(round.(model.β,digits=2),β,atol=0.1)
        @test isapprox(round.(get_params(agents,agent_options),digits=2)[[1,4]],α[[1,4]],atol=0.1)
        @test isapprox(ll,-14628.2,atol=0.1)
    ...
    @testset "sim-agents" begin
        ...
        α = [0.73, 1.0]
        @test isapprox(round.(model.β,digits=2),β,atol=0.01)
        @test isapprox(round.(get_params(agents,agent_options),digits=2)[1],α[1],atol=0.01)
        @test isapprox(ll,-16686.5,atol=0.1)
    ...
    @testset "shared-param" begin
        ...
        α = [0.97, 0.36]
        @test isapprox(round.(model.β,digits=2),β,atol=0.01)
        @test isapprox(round.(get_params(agents,agent_options),digits=2),α,atol=0.01)
        @test isapprox(ll,-14694.9,atol=0.1)
    ...
    #     @test isapprox(round.(model.β,digits=2),β,atol=0.01)
    #     @test isapprox(round.(get_params(agents,agent_options),digits=2),α,atol=0.01)
    #     @test isapprox(ll,-6410.2,atol=0.1)
    ...
    @testset "GLM" begin
        ...
        @test isapprox(round.(model.β,digits=2),β,atol=0.01)
        @test isapprox(ll,-5348.8,atol=0.1)
    ...
    #     @test isapprox(round.(model.β,digits=2),β,atol=0.01)
    #     @test isapprox(round.(get_params(agents,agent_options),digits=2),α,atol=0.01)
    #     @test isapprox(ll,-2743.2,atol=0.1)
...
@testset "MoAHMM-sim" begin
    ...
    @testset "3X1state-fit" begin
        ...
        @test mean(cor.(eachcol(model_sim.β),eachcol(Array(model_fit.β)))) > 0.9
    end
end
...
@testset "MoAHMM-priors" begin
    ...
    @testset "agent-priors" begin
        ...
        @test isapprox(round.(model.β,digits=2),β,atol=0.1)
        @test isapprox(round.(get_params(agents,agent_options),digits=2),α,atol=0.1)
        @test isapprox(ll,-15401.3,atol=0.1)
    ...
    @testset "HMM-priors" begin
        ...
        @test isapprox(round.(model.β,digits=2),β0,atol=0.1)
        @test isapprox(model.π,π0,atol=0.1)
        @test isapprox(model.A,A0,atol=0.1)
        @test isapprox(round.(get_params(agents,agent_options),digits=2),α0,atol=0.1)
        ...
        model,agents,ll = optimize(data,model_options,agent_options;init_hypers=false,disp_iter=10);
        @test isapprox(round.(model.β,digits=2),βmean,atol=0.1)
        @test isapprox(model.π,πmean,atol=0.1)
        @test isapprox(model.A,Amean,atol=0.1)
        @test isapprox(round.(get_params(agents,agent_options),digits=2),αmean,atol=0.1)
